<!-- Select variable toggle -->
<button data-modal-target="selectVariable" data-modal-toggle="selectVariable" class="block text-white bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm mx-5 my-3 px-5 py-2.5 text-center" type="button">
    Show variable
</button>
  
  <!-- Select variable modal -->
  <div id="selectVariable" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative p-4 w-full max-w-md max-h-full">
          <!-- Select variable Modal content -->
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <!-- Modal header -->
              <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                  <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                      Select a variable to show
                  </h3>
                  <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="selectVariable">
              ...
              <!-- Show variable Modal body -->
              <div class="p-4 md:p-5">
                  <form id="variableForm" class="space-y-4" action="#">
                    <x-formInput>
                    ...
                    <x-formInput>
                      ...
                      <input name="dbNumber" required min="0"  id="dbNumber" type="number" placeholder="DB number" required class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 appearance-none">
                    </x-formInput>
                    {{--  --}}
                    <x-formInput>
                      ...
                      <input name="varOffset" required min="0"  id="varOffset" type="number" placeholder="Variable Offset" required class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 appearance-none">
                    </x-formInput>
                    {{--  --}}
                    <x-formInput>
                      ...
                      <input name="bitPosition" value="0" min="0"  id="bitPosition" type="number" placeholder="Bit position" required class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 appearance-none">
                    </x-formInput>
                    {{--  --}}
                    <x-formInput>
