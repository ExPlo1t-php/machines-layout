<x-app-layout>
    ...
    <link rel="stylesheet" href="/css/draggable.css">
        ...
        class="{{$station->SN}} w-28 h-52 p-3 z-0 text-xs flex-col items-center justify-center text-center text-white bg-black/40  cursor-move draggable ui-widget-content">
        ...
        @endforeach
                    ...
                    style="top:{{$cabinet->posTop}}px; left:{{$cabinet->posLeft}}px;"
                     class="cabinet{{$cabinet->id}}  w-24 h-44 p-3 text-xs flex-col items-center justify-center text-center md:text-md sm:text-sm text-white bg-black/40 cursor-move ">
                    <h1>{{$cabinet->name}}</h1>
