<?php $__env->startSection('title', 'Layout | Update assembly line'); ?>


<?php $__env->startSection('component'); ?>
<form class="w-full max-w-lg flex-col self-center" method="POST" action="/updateLine/<?php echo e($line[$index]->id); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\layout\resources\views/components/forms/lineUpdate.blade.php ENDPATH**/ ?>