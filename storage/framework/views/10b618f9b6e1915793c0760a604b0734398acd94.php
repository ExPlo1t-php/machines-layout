<?php $__env->startSection('title', 'Layout | New equipment type'); ?>
...
<?php $component->withAttributes([]); ?>
          ...
          <input name="name" required class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="equipment type">
...
<?php $__env->startSection('table'); ?>
    ...
    <script type="text/javascript">
      ...
      $.ajax({
      type : 'get',
      url : '<?php echo e(URL::to('searchEquipmentType')); ?>',
      data:{'search':$value},
      ...
      <tbody>
        ...
        ?>
          ...
          <tr class="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
            ...
            <td class="px-6 py-4">
               <img src="/assets/images/equipments/<?php echo e($type['icon']); ?>" alt="icon" class="w-20 h-20">
              </td>
              <td class="px-4 py-4 text-right flex">
                <?php
                $url = urlencode($type['id']);
               ?>
                <a data-id="<?php echo e($type['id']); ?>" data-method="get" href="<?php echo e(route('showEquipmentType', $url)); ?>" id="edit" class="m-2 font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                <a data-id="<?php echo e($type['id']); ?>" data-method="DELETE" href="<?php echo e(route('deleteEquipmentType', $type['id'])); ?>" id="delete" class="m-2 font-medium text-red-600 dark:text-red-500 hover:underline">Delete</a>
            </td>
          </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\layout\resources\views/components/forms/equipmentType.blade.php ENDPATH**/ ?>