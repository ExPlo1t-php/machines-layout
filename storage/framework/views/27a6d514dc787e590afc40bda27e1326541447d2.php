...
<?php $component->withAttributes(['class' => 'w-full mr-3']); ?>
        ...
        <input value="<?php echo e($station[$index]->name); ?>" required name="name" class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="station name">
...
<?php $component->withAttributes(['class' => 'w-full mr-3']); ?>
    ...
    <input name="SN" value="<?php echo e($station[$index]->SN); ?>" class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="serial number" required>
   <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
  ...
  // adding 3 inputs of ip if type == bmb
    ...
    for (let j= 3; j >= 1 ; j--) {
      ...
      <?php if(strtolower($station[$index]->type) == 'bmb'): ?>
      <div class="flex flex-wrap -mx-3 mb-6" id="ipAddr1">
        <div class="w-full px-3">
          <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
            Ip address 1
          </label>
          <input value="<?php echo e($station[$index]->IpAddr1); ?>" required name="ipAddr1" class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="Ip address 1">
        </div>
      </div>
      <div class="flex flex-wrap -mx-3 mb-6" id="ipAddr2">
        <div class="w-full px-3">
          ...
          <input value="<?php echo e($station[$index]->IpAddr2); ?>" required name="ipAddr2" class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="Ip address 2">
        </div>
      </div>
      <div class="flex flex-wrap -mx-3 mb-6" id="ipAddr3">
        <div class="w-full px-3">
          ...
          <input value="<?php echo e($station[$index]->IpAddr3); ?>" required name="ipAddr3" class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="Ip address 3">
        </div>
      </div>
      <?php endif; ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <input name="link" value="<?php echo e($station[$index]->link); ?>" class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="AGW link">
   <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $component->withAttributes([]); ?>
    ...
    value="<?php echo e($station[$index]->state); ?>"
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\layout\resources\views/components/forms/stationUpdate.blade.php ENDPATH**/ ?>