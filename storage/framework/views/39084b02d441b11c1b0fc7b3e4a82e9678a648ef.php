        ...
        ?>
          ...
          <tr class="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
            ...
            <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                <?php if($line['icon']): ?>
                  <img src="/assets/images/lines/<?php echo e($line['icon']); ?>" alt="icon" class="w-20 h-20">
                  <?php endif; ?>
                </td>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\layout\resources\views/components/forms/line.blade.php ENDPATH**/ ?>