...
<?php if(isset($lineF)): ?>
<form class="w-full max-w-2xl flex-col self-center" method="POST" action="/addStation/<?php echo e($lineF['id']); ?>" enctype="multipart/form-data">
<?php else: ?>
...
<div class="flex flex-wrap  mb-6 w-full">
    <div class="w-full">
      ...
      class="appearance-none block w-full  text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password">
        <?php if(isset($lineF)): ?>
        <option value="<?php echo e($lineF['name']); ?>" selected hidden> <?php echo e($lineF['name']); ?></option>
        <?php else: ?>
        ...
        ?>
          ...
          <tr class="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
            ...
            <td class="px-6 py-4">
              ...
              <?php if($station['type'] == 'bmb'): ?>
                    <ul class="list-disc">
                    <li><?php echo e($station['IpAddr1']); ?></li>
                    <li><?php echo e($station['IpAddr2']); ?></li>
                    <li><?php echo e($station['IpAddr3']); ?></li>
                    </ul>
                <?php endif; ?>
              </td>
              <td class="px-6 py-4">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\layout\resources\views/components/forms/station.blade.php ENDPATH**/ ?>