<?php $__env->startSection('title', 'Layout | New station type'); ?>
...
<?php $__env->startSection('table'); ?>
    ...
    <script type="text/javascript">
      ...
      $.ajax({
      type : 'get',
      url : '<?php echo e(URL::to('searchStationType')); ?>',
      data:{'search':$value},
      ...
      <tbody>
        ...
        ?>
          ...
          <tr class="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
            ...
            <td class="px-6 py-4">
               <img src="/assets/images/machines/<?php echo e($type['icon']); ?>" alt="icon" class="w-1/7 h-1/7"> 
              </td>
              <td class="px-4 py-4 text-right flex">
                <a data-id="<?php echo e($type['name']); ?>" data-method="get" href="<?php echo e(route('showStationType', $type['name'])); ?>" id="edit" class="m-2 font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                <a data-id="<?php echo e($type['name']); ?>" data-method="DELETE" href="<?php echo e(route('deleteStationType', $type['name'])); ?>" id="delete" class="m-2 font-medium text-red-600 dark:text-red-500 hover:underline">Delete</a>
            </td>
          </tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\layout\resources\views/components/forms/stationType.blade.php ENDPATH**/ ?>